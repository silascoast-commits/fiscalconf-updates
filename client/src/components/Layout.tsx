...
import { Moon, Sun, FileText, Database, History, TrendingDown, Calculator, Rss, Scale, LayoutDashboard, CalendarDays, ArrowLeftRight, Users, Building2, ChevronDown, X, FileCode2, MoreHorizontal, BotMessageSquare, MapPin, BookOpen, Banknote } from "lucide-react";
...
const navMain = [
  ...
  { href: "/folha",      label: "Folha Pagto.", icon: Banknote },
];
